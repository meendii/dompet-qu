...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top main-nav" id="mainNav">
        <div class="container">
            <a class="js-scroll-trigger" href="#page-top">
                <img src="img/logo.jpg" width="20px" style="margin-right: 10px; margin-bottom: 2px;">
            </a>
            <a class="navbar-brand js-scroll-trigger" href="#page-top">Keuangan</a>
    ...
    <section id="about" class="bg-primary parallax2">
        <div class="container">
            <div style="color: white;" class="garis garis3 text-center">Kelompok 5</div>
            <div class="row text-center">
                <div class="col-lg-4">
                    <div class="team">
                        ...
                        <div class="teks">
                            <h3 class="job-desk">231351106</h3>
                            <p>Muhammad Ridho Ihsan Hakim</p>
                ...
                <div class="col-lg-4">
                    <div class="team">
                        ...
                        <div class="teks">
                            <h3 class="job-desk">231351127</h3>
                            <p>Randi Priatna</p>
                            <p>Teknik Informatika</p>
                        </div>
                    </div>
        ...
        <div class="container text-light">
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <p class="mb-0 mt-2">Copyright ©kelompok 5 </p>
                </div>
            </div>
        </div>
    </div>
